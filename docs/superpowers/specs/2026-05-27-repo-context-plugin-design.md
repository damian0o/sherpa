...
| **Slack** | `context-ingest` | Ingest a thread, channel summary, or pinned message into a `raw/` summary + topic proposal. Per `docs/llm-wiki-idea.md` ("fed by Slack threads, meeting transcripts"). |
